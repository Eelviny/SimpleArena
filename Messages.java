...
public class Messages {
	...
	public static synchronized void loadMessages(){
		...
		setMessage("simplearena.sign.place", ChatColor.RED+"You may not place a sign that begins with the line \"Arena\"!");
		setMessage("simplearena.sign.nothing", ChatColor.RED+"%text% does not correspond to any known Arena or Class!");
		...
		setMessage("simplearena.class.arena", ChatColor.RED+"You must be in an Arena to change Class!");
		
		
		setMessage("simplearena.join.normal", "&8[Arena] &9%player% joined queue!");
		setMessage("simplearena.join.full", ChatColor.YELLOW+"This Arena is full. Please wait, a new match will begin shortly.");
		setMessage("simplearena.join.noperm", ChatColor.RED+"You do not have permission to join Arenas!");
		setMessage("simplearena.join.inprogress", ChatColor.YELLOW+"Please wait. A match is currently in progress!");
